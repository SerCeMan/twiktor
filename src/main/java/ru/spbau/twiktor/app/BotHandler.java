...
public class BotHandler {
    ...
    public BotHandler() {
        addBot("WiktorGrishin", "iambot");
    }

    public void addBot(String login, String password) {
        try {
            Twiktor twiktor = new Twiktor(login, new TwitTransformerImpl(), people, createAccesToken(login, password));
    ...
    private AccessToken createAccesToken(String login, String password) {
